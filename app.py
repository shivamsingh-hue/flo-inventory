...
async function loadData(force){
  ...
  try{
    ...
    const datePart=parts[0]||ref;
    const timePart=parts[1]||'';
    document.getElementById('statQty').textContent=qty;
    document.getElementById('statTime').textContent=(timePart||datePart)+' ✓';
    document.getElementById('statDate').textContent=datePart+' '+(timePart||'');
